...
# by class
driver.find_element(By.CSS_SELECTOR, "input.nav-progressive-attribute.nat-input")
...
driver.find_element(By.CSS_SELECTOR, ".nav-progressive-attribute[placeholder='Search Amazon'][aria-label ='Search Amazon']")
